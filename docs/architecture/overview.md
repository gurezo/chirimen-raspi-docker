...
│   └── web-demo/               # Browser demo（Polyfill / 接続状態 UI）
├── libs/
│   ├── core/                   # 共通エラー / 型
...
| `apps/web-demo` | Browser から Runtime を試す demo UI（Browser Polyfill 組み込み済み。接続状態 UI あり。GPIO・I2C 導線は後続） |
