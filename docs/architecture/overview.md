...
32-bit OS は Raspberry Pi 3 B+（`armv7l`）と Raspberry Pi 4 Model B Rev 1.4（64-bit kernel / `aarch64`）で Verified。詳細は [docker.md の Compatibility matrix](./docker.md#compatibility-matrix)。
