...
| 対応環境を確認する | [Compatibility](docs/architecture/compatibility.md)（Browser Development Flow の実機 E2E は [#243](https://github.com/gurezo/chirimen-raspi-docker/issues/243)） |
