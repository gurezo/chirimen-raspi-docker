...
| ドキュメント | 内容 |
| --- | --- |
| [Compatibility matrix](docs/architecture/compatibility.md) | Pi 3 B+ / 4 / 5 の 64-bit 実機検証結果。32-bit OS はサポート対象外。I2C Host Setup は [#219](https://github.com/gurezo/chirimen-raspi-docker/issues/219) |
